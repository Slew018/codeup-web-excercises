...
//      -> Wrap all of this in a function and call that function (your event won't fire unless
//      it's actually called to be added, right?)
...
function removeImageClickEvent(){
    ...
    sus.removeEventListener('click', appendSusNode);
}
